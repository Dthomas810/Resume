...
\name{Dwayne}{Thomas}
\address{1616 183rd st , Homewood , IL , 60430}
\mobile{ 630-464-3851 }

\email{Dthomas810@live.com}
...
\makecvfooter{}{Dwayne R. Thomas~~~·~~~Résumé}{} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
